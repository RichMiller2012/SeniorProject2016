...
<div id=main-wrapper>
  ...
  <div class=header-wrapper>
    <div class="header">
      <img id="header-door" src="img/door.png" alt="door"/>
      <h1 id="header-title">The Family Homestead</h1>
      <img id="search-bar" src="img/search-bar.jpg" alt="search-bar.jpg">
	  <div id="media-links">
		  <ul>
    ...
    <div class="row main-content">
      ...
      <div class="col-md-3">
        <div class="updates-info">
          <h5>Website Updates Secion</h5>
          <br>
          <h5>Update 1!</h5>
          <p>Sed et facilisis ligula. Nullam vitae velit fermentum augue pharetra aliquet vitae vitae erat.</p>
          <h5>Update 2!</h5>
          <p>Sed et facilisis ligula. Nullam vitae velit fermentum augue pharetra aliquet vitae vitae erat.</p>
        </div>
      </div>
